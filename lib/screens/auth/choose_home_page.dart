    ...
    return Container(
      ...
      child: Scaffold(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Домашний адрес",
                  style: TextStyle(color: AppColor.kWhite, fontSize: 13.sp),
                ),
                SizedBox(height: 10.h),
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                      primary: AppColor.kWhite, minimumSize: Size(163.w, 36.h)),
                  onPressed: () {},
                  child: const Text(
                    "Добавить",
        ...
        bottomSheet: mainBottomsheet(context, navigatorPage: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => AriasPage()));
        },buttonTitle: "Готово"),
      ),
    );
  }
